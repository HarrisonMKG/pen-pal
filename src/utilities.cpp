...
ExampleArgs ParseExampleArguments(int argc, char *argv[])
{
    ...
    options.add_options()
        ...
        ("c,coordinates", "file path to coordinates csv data", cxxopts::value<std::string>()->default_value("coordinates/Pen_Pal_with_lift.csv"))
        ("g,gain", "file path to gain values used", cxxopts::value<std::string>()->default_value("../gain_values/gain.txt"))
